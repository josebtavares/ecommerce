          ...
          <div v-show="mobileActiveTab === 'produtos'" class="flex h-full flex-col overflow-y-auto p-4">
            <div class="flex h-full flex-col">
              ...
              <div class="mb-4 shrink-0 overflow-x-auto">
                <div class="flex gap-2 pb-2">
                  ...
                  <button
                    ...
                    :class="[
                      'shrink-0 whitespace-nowrap rounded-full px-4 py-2 text-sm font-black transition',
              ...
              <div class="min-h-0 flex-1">
                ...
                <div
                  v-else
                  class="grid grid-cols-2 gap-3 pb-4 sm:grid-cols-3"
                >
                  <button
        ...
        <section class="min-h-0 overflow-hidden border-r border-slate-200 p-6">
          <div class="flex h-full flex-col">
            ...
            <div class="min-h-0 flex-1 overflow-y-auto">
              <div
                v-if="loadingProdutos && produtos.length === 0"
                class="grid grid-cols-3 gap-3 xl:grid-cols-4"
              >
                <div
                  v-for="i in 8"
                  :key="i"
              ...
              <div
                v-else
                class="grid grid-cols-3 gap-3 pb-4 xl:grid-cols-4"
              >
                <button
                  v-for="produto in produtosFiltrados"
                  :key="produtoUid(produto)"
